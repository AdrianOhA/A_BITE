...
<section class="post-news-area section-padding-100-0 mb-70"
	...
	<div class="container">
					...
					<div class="blog-content col-12">
						<div class="col-xl-12">
							...
							<div class="post-meta margin-top-15">
								<a href="#" class="post-author">제목 <span class="input-group">
										<input type="text" class="form-control form" placeholder="제목"
							...
							<div class="post-meta margin-top-15" style="margin-bottom: 0px;">
								<a href="#" class="post-date">판매 가격: <span
									class="input-group"> <input type="text"
										class="form-control form" placeholder="금액"
								...
								</a> <a href="#" class="post-date">판매 수량: <span
									class="input-group"> <input type="text"
										class="form-control form" placeholder="수량"
								...
								</a> <a href="#" class="post-date" style="margin-left: 20px;">태그:
									<span class="input-group"> <input type="text"
										class="form-control" placeholder="예) #꿀맛 #1인분"
							...
							<div ng-repeat="detail in recipe.details" class="margin-top-15">
								...
								<div>
									<textarea rows="3" cols="100" placeholder="레시피 내용"
				...
				<div class="sidebar-area">
					...
					<div class="recipe-info">
						...
						<ul class="info-data">
							...
							<li><img src="/images/alarm-clock.png" alt=""><span>가격: {{recipe.sellPay}}원 <br>남은 수량: {{recipe.sellCnt}}</span></li>
							<li>
		...
		<div class="margin-top-15" style="padding-left: 30px;">
			...
			<div class="input-group">
				<textarea rows="20" cols="100" placeholder="요리 소개"
					class="form-control form"
